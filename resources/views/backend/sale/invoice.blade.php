    ...
    <div id="receipt-data"> 
        <div class="centered">
            @if($general_setting->site_logo)
                <img src="{{url('public/logo', $general_setting->site_logo)}}" height="42" width="70" style="margin:10px 0;filter: brightness(0);">
            @endif
        ...
        <table class="table-data">
            <thead>
                <tr>
                    <th style="text-align: left !important;">{{__('Item')}}</th>
                    <th style="text-align: left !important;">{{__('Price')}}</th>
                    <th style="text-align: left !important; min-width: 80px">{{__('Qty')}}</th>
                    <th>{{__('Total')}}</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    ...
                    <td style="padding: 5px;width:30%">{{trans('file.Due')}}: {{number_format((float)$payment_data->change, 2, '.', '')}}</td>
                </tr>                
                @endforeach
                ...
                <tr>
                    <td colspan="4" style="text-align: center !important;" ><a style="color: #000; text-decoration: none; text-transform: lowercase;" href="http://amishghor.com/">www.amishghor.com</a></td>
                </tr>
            </tbody>
        </table>
