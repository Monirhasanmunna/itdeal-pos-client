                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select required name="customer_id" id="customer_id" class="selectpicker form-control"
                    ...
                    <input type="hidden" name="biller_id" value="{{ collect($lims_biller_list)->first()->id }}">
                    {{-- <div class="col-md-4">
                                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="number" name="paying_amount" class="form-control" id="paying-amount"
                            step="any" />
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="number" name="paid_amount" class="form-control" id="paid-amount"
                            step="any" />
                        </div>
                      </div>
                      <div class="col-md-3">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              @if (count($lims_warehouse_list) == 1)
                <input type="hidden" name="warehouse_id" value="{{ collect($lims_warehouse_list)->first()->id }}">
              @else
...
@push('scripts')
  <script type="text/javascript">
   ...
   // $('select[name="warehouse_id"]').trigger('input');
    ...
    $('button[name="update_btn"]').on("click", function() {
      ...
      if (product_type[pos] == 'standard') {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sale-unit').val(temp_unit_name[
          position]);
    ...
    $("#myTable").on("change", ".batch-no", function() {
      ...
      $.get('../check-batch-availability/' + product_id + '/' + $(this).val() + '/' + warehouse_id, function(data) {
        if (data['message'] != 'ok') {
          ...
          $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.product-batch-id').val(data[
            'product_batch_id']);
          $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.expired-date').text(data[
            'expired_date']);
        ...
        success: function(data) {
          ...
          if (pre_qty > 0) {
            ...
            if (!data[11] && product_warehouse_price[pos]) {
              product_price[rowindex] = parseFloat(product_warehouse_price[pos] * currency['exchange_rate']) +
                parseFloat(product_warehouse_price[pos] * currency['exchange_rate'] * customer_group_rate);
            } else {
              product_price[rowindex] = parseFloat(data[2] * currency['exchange_rate']) + parseFloat(data[2] *
          ...
          if (flag) {
            ...
            cols += '<td>' + data[1] + '</td>';
            cols += '<td><input type="number" class="form-control qty" name="qty[]" value="' + data[15] +
            ...
            if (!data[11] && product_warehouse_price[pos]) {
              product_price.splice(rowindex, 0, parseFloat(product_warehouse_price[pos] * currency[
                'exchange_rate']) + parseFloat(product_warehouse_price[pos] * currency['exchange_rate'] *
                customer_group_rate));
            } else {
              product_price.splice(rowindex, 0, parseFloat(data[2] * currency['exchange_rate']) + parseFloat(data[
                2] * currency['exchange_rate'] * customer_group_rate));
            }
        ...
        $.ajax({
          ...
          success: function(data) {
            pos = product_code.indexOf($('table.order-list tbody tr:nth-child(' + (rowindex + 1) +
              ') .product-code').val());
            product_price[rowindex] = parseFloat(data[0] * currency['exchange_rate']) + parseFloat(data[0] *
              currency['exchange_rate'] * customer_group_rate);
          }
        });
      }
    ...
    function calculateRowProductData(quantity) {
      ...
      $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.discount-value').val((product_discount[
        rowindex] * quantity).toFixed(2));
      $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-rate').val(tax_rate[rowindex].toFixed(
        2));
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $.each(data, function(index) {
              ...
              $('select[name="gift_card_id"]').append('<option value="' + data[index]['id'] + '">' + data[
                index]['card_no'] + '</option>');
            });
            $('.selectpicker').selectpicker('refresh');
          }
        });
    ...
    $(document).on('submit', '.payment-form', function(e) {
      ...
      if (rownumber < 0) {
        ...
        alert('Paying amount cannot be bigger than recieved amount');
        e.preventDefault();
      } else if ($('select[name="payment_status"]').val() == 3 && parseFloat($("#paid-amount").val()) == parseFloat($(
