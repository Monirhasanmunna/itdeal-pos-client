  ...
  <nav class="side-navbar">
    ...
    <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          <ul id="transfer" class="collapse list-unstyled ">
            ...
            @if ($add_permission_active)
              ...
              <li id="transfer-import-menu"><a
                  href="{{ url('transfers/transfer_by_csv') }}">{{ trans('file.Import Transfer By CSV') }}</a></li>
            @endif
          </ul>
        </li>
      @endif
      ...
      @if ($customer_index_permission_active)
        <li><a href="#customer_menu" aria-expanded="false" data-toggle="collapse"> <i
              class="dripicons-user"></i><span>{{ trans('Customer') }}</span></a>
          <ul id="customer_menu" class="collapse list-unstyled ">
            @if ($customer_index_permission_active)
      ...
      @endif
      @if ($customer_index_permission_active)
        <li><a href="#owner_menu" aria-expanded="false" data-toggle="collapse"> <i
              class="dripicons-user"></i><span>{{ trans('Owner') }}</span></a>
          <ul id="owner_menu" class="collapse list-unstyled ">
            @if ($customer_index_permission_active)
              <li id="owner-list-menu"><a href="{{ route('owner.index') }}">{{ trans('Owner List') }}</a></li>
              <?php
              $customer_add_permission_active = DB::table('permissions')
                  ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                  ->where([['permissions.name', 'customers-add'], ['role_id', $role->id]])
              ...
              ?>
              @if ($customer_add_permission_active)
                <li id="owner-create-menu"><a href="{{ route('owner.create') }}">{{ trans('Add Owner') }}</a></li>
              @endif
            @endif
          </ul>
        </li>
      @endif
      @if ($customer_index_permission_active)
        <li><a href="#bank_menu" aria-expanded="false" data-toggle="collapse"> <i
              class="dripicons-user"></i><span>{{ trans('Bank') }}</span></a>
          <ul id="bank_menu" class="collapse list-unstyled ">
            @if ($customer_index_permission_active)
              <li id="bank-list-menu"><a href="{{ route('bank.index') }}">{{ trans('Bank List') }}</a></li>
              <?php
              $customer_add_permission_active = DB::table('permissions')
                  ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                  ->where([['permissions.name', 'customers-add'], ['role_id', $role->id]])
              ...
              ?>
              @if ($customer_add_permission_active)
                <li id="bank-create-menu"><a href="{{ route('bank.create') }}">{{ trans('Add Bank') }}</a></li>
              @endif
            @endif
          </ul>
        </li>
      ...
      @if ($supplier_index_permission_active)
        <li><a href="#supplier_menu" aria-expanded="false" data-toggle="collapse"> <i
              class="dripicons-user"></i><span>{{ trans('Supplier') }}</span></a>
          <ul id="supplier_menu" class="collapse list-unstyled ">
            @if ($supplier_index_permission_active)
      ...
      @if ($user_index_permission_active)
        <li><a href="#user_menu" aria-expanded="false" data-toggle="collapse"> <i
              class="dripicons-user"></i><span>{{ trans('User') }}</span></a>
          <ul id="user_menu" class="collapse list-unstyled ">
            @if ($user_index_permission_active)
      ...
      @if (
        ...
        <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i
          ...
          <ul id="report" class="collapse list-unstyled ">
            <li>
              <a id="" href="{{route('report.profit_report')}}">{{ trans('Profit Report') }}</a>
            </li>
            <li>
              <a id="" href="{{route('report.product_ledger')}}">{{ trans('Product Ledger') }}</a>
            </li>
            <li>
              <a id="" href="{{route('report.customer_ledger')}}">{{ trans('Customer Ledger') }}</a>
            </li>
            <li>
              <a id="" href="{{route('report.customer_product')}}">{{ trans('Customer Wise Sales') }}</a>
            </li>
            <li>
              <a id="" href="{{route('report.product_customer')}}">{{ trans('Product wise sales') }}</a>
            </li>
            <li>
              <a id="" href="{{route('report.cashbook')}}">{{ trans('Cashbook') }}</a>
            </li>
      ...
      <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
        ...
        <ul id="setting" class="collapse list-unstyled ">
          ...
          @if ($discount_permission_active)
            <li id="discount-list-menu"><a href="{{ route('discounts.index') }}">{{ trans('file.Discount') }}</a>
            </li>
          @endif
          ...
          @if ($create_sms_permission_active)
            <li id="create-sms-menu"><a href="{{ route('setting.createSms') }}">{{ trans('file.Create SMS') }}</a>
            </li>
          @endif
          ...
          {{-- @if ($mail_setting_permission_active)
            <li id="mail-setting-menu"><a href="{{ route('setting.mail') }}">{{ trans('file.Mail Setting') }}</a>
            </li>
          @endif
      ...
      <nav class="navbar">
        ...
        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
          ...
          <li class="nav-item"><a id="switch-theme" data-toggle="tooltip"
              title="{{ trans('file.Switch Theme') }}"><i class="dripicons-brightness-max"></i></a></li>
          ...
          @if (\Auth::user()->role_id <= 2)
            <li class="nav-item"><a href="{{ route('cashRegister.index') }}" data-toggle="tooltip"
                title="{{ trans('file.Cash Register List') }}"><i class="dripicons-archive"></i></a></li>
          @endif
            ...
            <li class="nav-item" id="notification-icon">
              ...
              <ul class="right-sidebar">
                <li class="notifications">
                  <a href="{{ route('report.qtyAlert') }}" class="btn btn-link"> {{ $alert_product }} product
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <select name="receiver_id" class="selectpicker form-control" required data-live-search="true"
        ...
        <div class="row">
          <div class="col-sm-12">
            <p>&copy; {{ $general_setting->site_title }} | {{ trans('file.Developed') }} {{ trans('file.By') }}
              <span class="external">{{ $general_setting->developed_by }}</span> | V 3.8
            </p>
          </div>
        </div>
      </div>
