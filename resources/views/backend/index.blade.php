              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    <div class="icon"><i class="dripicons-graph-bar" style="color: var(--theme-color)"></i></div>
                    <div>
                        <div class="count-number revenue-data">{{number_format((float)$revenue, 2, '.', '')}}</div>
                        <div class="name"><strong style="color: var(--theme-color)">{{ trans('file.revenue') }}</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
