...
<section>
    <div class="container-fluid">
        ...
        <a href="{{route('bank.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('Add Bank')}}</a>
        @endif
    </div>
    <div class="table-responsive">
        <table id="supplier-table" class="table">
            ...
            <tbody>
                @foreach($lims_bank_all as $key => $bank)
                <tr data-id="{{$bank->id}}">
                    <td>{{$key}}</td>
                    <td>{{$bank->name}}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="{{ route('bank.edit', $bank->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                @endif
                                <li class="divider"></li>
...
<script type="text/javascript">
    ...
    $("ul#bank_menu #bank-list-menu").addClass("active");
