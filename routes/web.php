...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
	...
	Route::post('owner/transection', 'OwnerController@transection')->name('owner.transection');
	Route::get('owner/balance/{id}', 'OwnerController@bank_balance');
	Route::get('owner/transectionlist/{id}', 'OwnerController@transectionlist');
	...
	Route::get('report/profit_report', 'ReportController@profit_report')->name('report.profit_report');
	Route::get('report/product_ledger', 'ReportController@product_ledger')->name('report.product_ledger');
	Route::get('report/customer_ledger', 'ReportController@customer_ledger')->name('report.customer_ledger');
	Route::get('report/customer_product', 'ReportController@customer_product')->name('report.customer_product');
	Route::get('report/product_customer', 'ReportController@product_customer')->name('report.product_customer');
	Route::get('report/cashbook', 'ReportController@cashbook')->name('report.cashbook');
